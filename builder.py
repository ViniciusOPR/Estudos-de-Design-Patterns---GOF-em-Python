...
class IUserBuilder(ABC):
    ...
    @abstractmethod
    def add_lastname(self, firstname) -> UserBuilder: pass

    @abstractmethod
    def add_age(self, firstname) -> UserBuilder: pass

    @abstractmethod
    def add_phone(self, firstname) -> UserBuilder: pass

    @abstractmethod
    def add_address(self, firstname) -> UserBuilder: pass
